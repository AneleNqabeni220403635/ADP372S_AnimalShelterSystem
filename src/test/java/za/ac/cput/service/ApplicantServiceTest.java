...
class ApplicantServiceTest {
    ...
    void create()
    {
        // TODO: Decide on if ids should be generated by the database or if we are going to generate each one, currently we have a mix and its throwing off the entities when sending it to DB
